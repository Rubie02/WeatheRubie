...
searchFiled.addEventListener("input", function () {
    ...
    if (searchFiled.value) {
        searchTimeout = setTimeout(() => {
            fetchData(url.geoOn(searchFiled.value), function (locations) {
            searchFiled.classList.remove("searching");
        ...
        fetchData(url.forecast(lat, lon), function (forecast){
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                <div class="card card-sm slider-card">
                    ...
                    <img src="./assets/images/weather_icons/${icon}.png" width="48px" height="48px" loading="lazy" 
                ...
                <div class="card card-sm slider-card">
                    <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
                    <img src="./assets/images/weather_icons/direction.png" width="48px" height="48px" loading="lazy" 
